    ...
    static var sampleChildren: [Child] = [
        Child(
            ...
            busTracking: BusTracking(
                ...
                busCoordinate: CLLocationCoordinate2D(latitude: 33.7490, longitude: -84.3900),
                stopCoordinate: CLLocationCoordinate2D(latitude: 33.7525, longitude: -84.3858),
        ...
        Child(
            ...
            busTracking: BusTracking(
                ...
                stopsAway: 7,
                hasArrivedAtSchool: false,
                busCoordinate: CLLocationCoordinate2D(latitude: 33.7462, longitude: -84.3920),
                stopCoordinate: CLLocationCoordinate2D(latitude: 33.7525, longitude: -84.3858),
                schoolCoordinate: CLLocationCoordinate2D(latitude: 33.7565, longitude: -84.3815),
